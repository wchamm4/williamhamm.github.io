...
// Declare the thisDate variable containing the current date and time
let thisDate = new Date();

// Declare the dateString variable containing the localized text of the thisDate variable
let dateString = thisDate.toLocaleDateString();

// Declare the dateHTML variable containing the date in an <h2> heading format
...
// Use the thisDay variable as the parameter for getEvent() to retrieve HTML for that day's events
let eventHTML = getEvent(thisDay);

// Insert dateHTML and eventHTML before the end of the element with ID unionToday
document.getElementById("unionToday").insertAdjacentHTML("beforeend", dateHTML + eventHTML);

// Function to retrieve events based on the day of the week
   ...
   switch (day) {
      ...
      case 5: // Friday Events
         eventHTML = "<dl> \
            ...
            <dd><p>Meet people from around the world in a relaxing atmosphere.</p> \
      ...
      case 6: // Saturday Events
         eventHTML = "<dl> \
            ...
            <dd><p>Enjoy beautiful kites from around the world and then make and fly kites.</p>\
